...
export function deleteRequest(
  name: string,
  options: HttpMethodFunctionOptions
): void;
 ...
 * @param options Configuration options describing the inputs, outputs, and handler for this function
 */
export function storageBlob(
  name: string,
  options: StorageBlobFunctionOptions
): void;
...
export function storageQueue(
  name: string,
  options: StorageQueueFunctionOptions
): void;
...
export function serviceBusTopic(
  name: string,
  options: ServiceBusTopicFunctionOptions
): void;
...
export function eventGrid(
  name: string,
  options: EventGridFunctionOptions
): void;
