...
export type ServiceBusQueueHandler = (
  message: unknown,
  context: InvocationContext
) => FunctionResult;

export interface ServiceBusQueueFunctionOptions
...
export type ServiceBusQueueTrigger = FunctionTrigger &
...
export type ServiceBusQueueOutput = FunctionOutput &
  ServiceBusQueueOutputOptions;

export type ServiceBusTopicHandler = (
  message: unknown,
  context: InvocationContext
) => FunctionResult;

export interface ServiceBusTopicFunctionOptions
...
export type ServiceBusTopicTrigger = FunctionTrigger &
...
export type ServiceBusTopicOutput = FunctionOutput &
